                ...
                <div className="col-md-6">
                    <div className="card">
                        <div className="card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h1 style={{ flexGrow: 1, textAlign: 'center', margin: 0 }}>Enter User Details</h1>
                        ...
                        <div className="card-body">
                            ...
                            <div className="mb-3">
                                ...
                                <select name="gender" className="form-select"  value={gender} onChange={e => setGender(e.target.value)} required>
